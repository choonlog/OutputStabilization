...
Cell Collective로 부터 구한 biological Boolean logic을 사용하여 random Boolean network를 생성한다.
구조는 Scale-free다.
+
지정한 수 만큼의 output nodes를 보장한다.
e.g., formatAttr, formatNormal, indegreeTotalLength = main(10, 1, 5, 2) 라면
Number of output nodes >= 2 를 보장한다.
"""
